...
- Select Project > Properties > PHP Include Path
- Select libraries > Add External Folder
- Search for the path to Bluevia's SDK
- Click OK
...
- [Location](https://github.com/BlueVia/Official-Library-PHP/tree/master/samples/LocationExample.php) : Gets the location of a user,
- [User context](https://github.com/BlueVia/Official-Library-PHP/tree/master/samples/DirectoryExample.php) : Gets user and user equipement information
- [Advertising](https://github.com/BlueVia/Official-Library-PHP/tree/master/samples/AdvertisingExample.php) : Gets advertising.
